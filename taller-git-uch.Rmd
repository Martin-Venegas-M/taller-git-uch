...
- Git es un sistema de control de versiones distribuido que se utiliza de manera local (en el propio computador)

- GitHub es un servicio en la nube que permite almacenar repositorios Git y colaborar en ellos con otras personas.
...
- Git es el software que hace el trabajo de llevar el control de versiones y funciona a través de comandos en consola. Trabajar en él puede ser un poco criptico al principio.

- Es recomendable trabajar con alguna GUI (Interfaz Gráfica de Usuario) para facilitar su uso
...
- El contenido de la carpeta puede variar dependiendo del alcance del proyecto y de las tareas. Un repositorio puede ser un paper/informe, una parte del procesamiento de datos o un proyecto entero (ej. Fondecyt).
...
1. **Nuevo proyecto, Github primero → ¡Esta es la que veremos aquí!**
2. Proyecto existente, Github primero
3. Proyecto existente, Github al final
...
---
.center[![](images/git-workflow.png)]
---
## Crear repositorio remoto desde Github

En Github, ir al perfil propio y hacer click en botón verde "New".
...
.left-column[Introducir la información del repositorio:

- _**Repository template:**_ no es necesario por ahora
- _**Repository name:**_ escoger un nombre (sin espacios)
- _**Description:**_ descripción breve del repositorio
- _**Public o Private:**_ público (a menos que haya una razón para dejarlo privado)
- _**Add a README file:**_ marcar casilla
- _**Add .gitignore:**_ R (a menos que se use otro programa)
- _**Choose a license:**_ ninguna

Apretar botón verde "Create repository"
]
...
Si solicita autorización, entrar a través del navegador con las credenciales Github (o Token).

.center[![:scale 63%](images/clone_repo6.png)]
---
## Hacer cambios, commit, pull, push

Un push exitoso se debería ver asi:
...
Si solicita autorización, utilizar credenciales o token Github.
...
En Github aparecerá la nueva rama:
...
Añadir información relevante respecto a la solicitud _(pull request)_. Por defecto el título es el nombe del último commit. Hacer click en "Create pull request".
...
.center[![:scale 50%](images/merge4.png)]
...
Y en Github se verá así:

.center[![:scale 70%](images/merge6.png)]

---
# Conceptos centrales
## 7. Historial y deshacer cambios _(History)_
